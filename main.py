...
print(args.env_name, 'x:', num_inputs, 'a:', num_actions)
...
def update_params(batch):
	...
	def get_value_loss(flat_params):
		...
		value_loss.backward()
		# (value_loss.data.double().numpy()[0], get_flat_grad_from(value_net).data.double().numpy())
		# print(value_loss.shape, get_flat_grad_from(value_net).shape)
		return value_loss.item(), get_flat_grad_from(value_net).detach().double().numpy()
